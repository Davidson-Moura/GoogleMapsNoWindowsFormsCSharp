...
namespace MyMap.Source
{
    ...
    public class Stuff
    {
        ...
        public const string GoogleMapsApiKey = "AIzaSyDDoEheUKGbgYococzXoDG9wLGBAYMYpfo";//"AIzaSyDn8qjiDcnGHOriIrmCnbHs8RK4h_WoGpg"; // from Demo.Geocoding project
        public const string OpenStreetMapsGraphHopperApiKey = "c2aa79b0-4ee1-4ca3-86e6-f6a013de26d2"; // from Demo.Geocoding project
        //private readonly string _apiKey = "AIzaSyDDoEheUKGbgYococzXoDG9wLGBAYMYpfo";
